...
const TITLE = "Kraken Web Integrations";
const DESCRIPTION = "Customize your NZXT Kraken";
  ...
  return (
    <div className={`${isLandingPage ? "page--landing" : ""}`}>
      <Head>
        ...
        <meta property="og:url" content="https://web-integrations.nzxt.com" />
        <meta property="og:title" content={title} />
        <meta property="og:description" content={description} />
        <meta
          property="og:image"
          content="https://web-integrations.nzxt.com/images/nzxt.svg"
        />
      ...
      <TopNav>
        <Link href="/docs/web-integrations">Docs</Link>
        <Link href="http://github.com/nzxtcorp">GitHub</Link>
        <Link href="https://discord.com/invite/nzxt">Discord</Link>
        <Link href="https://twitter.com/nzxt">Twitter</Link>
      </TopNav>
      <div className="page">
        {isDocs ? <SideNav /> : null}
