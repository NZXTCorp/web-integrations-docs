  ...
  return (
    <div className={`${isLandingPage ? "page--landing" : ""}`}>
      <Head>
        ...
        <meta property="og:url" content="https://developer.nzxt.com" />
        <meta property="og:title" content={title} />
        <meta property="og:description" content={description} />
        <meta
          property="og:image"
          content="https://developer.nzxt.com/images/nzxt.svg"
        />
      ...
      <TopNav>
        ...
        <Link href="https://github.com/NZXTCorp/web-integrations-docs">
          GitHub
        </Link>
